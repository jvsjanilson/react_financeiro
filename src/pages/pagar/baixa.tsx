...
const PagarBaixa: React.FC = () => {
    ...
    const formSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        pagarService.baixar(id, {data_pagamento: dataPagamento}).then(response => {
            navigate('/pagars');
        }).catch(err => {
    ...
    return (
        <div className="container d-flex justify-content-center mt-4">
            ...
            <Form onSubmit={formSubmit}>
                <Card >
                    <Card.Header>
                        <Card.Title className="text-center">Baixa de título a pagar</Card.Title>
                    </Card.Header>
                    <Card.Body>
                        <div className="row">
